...
לכן, **NaOEt מניב בעיקר את תוצר זייצב, בעוד t-BuOK מניב בעיקר את תוצר הופמן**.`
  ...
  ,
  {
    id: 63,
    category: "nomenclature_alkanes",
    title: "נומנקלטורה של ציקלואלקנים דו-מותמרים – עדיפות אלפביתית",
    text: "מהו השם הסיסטמתי (IUPAC) הנכון עבור המולקולה הבאה?",
    svg: `<svg viewBox="0 0 300 160" width="100%" height="160" style="background:#1e293b; border-radius:8px; direction: ltr;">
      <!-- Cyclohexane ring -->
      <polygon points="120,50 160,75 160,115 120,140 80,115 80,75" fill="none" stroke="#f8fafc" stroke-width="3"/>
      <!-- tert-butyl at C1 (120, 50) -->
      <line x1="120" y1="50" x2="120" y2="25" stroke="#38bdf8" stroke-width="3"/>
      <line x1="120" y1="25" x2="95" y2="15" stroke="#38bdf8" stroke-width="2"/>
      <line x1="120" y1="25" x2="120" y2="2" stroke="#38bdf8" stroke-width="2"/>
      <line x1="120" y1="25" x2="145" y2="15" stroke="#38bdf8" stroke-width="2"/>
      <!-- Methyl at C4 (120, 140) -->
      <line x1="120" y1="140" x2="120" y2="158" stroke="#f43f5e" stroke-width="3"/>
      <!-- Labels for carbons -->
      <text x="115" y="65" fill="#38bdf8" font-size="11" font-weight="bold">1</text>
      <text x="115" y="133" fill="#f43f5e" font-size="11" font-weight="bold">4</text>
    </svg>`,
    options: [
      "1-tert-butyl-4-methylcyclohexane",
      "4-tert-butyl-1-methylcyclohexane",
      "1-(1,1-dimethylethyl)-4-methylcyclohexane",
      "4-(1,1-dimethylethyl)-1-methylcyclohexane"
    ],
    correctIndex: 0,
    explanation: `להלן כללי קביעת שם ה-IUPAC הסיסטמתי עבור ציקלואלקן דו-מותמר בעמדות 1,4:

**שלב 1: מספור הטבעת לקבלת Locants נמוכים ביותר**
עבור מתמירים בעמדות 1 ו-4, כל מסלול שנתחיל בו ייתן את סט המספרים 1,4 (בין אם נתחיל מהמתיל ובין אם מה-tert-butyl).

**שלב 2: פתרון השוויון בעזרת עדיפות אלפביתית**
כאשר ישנו שוויון במספרים, המקום הראשון (1) מוקצה למתמיר ששמו מופיע ראשון בסדר האלפבית האנגלי:
- **tert-butyl** מול **methyl**:
  - במיון אלפביתי של מתמירים, קידומות מחוברות בקו מפריד (כמו tert- ו-sec-) אינן נלקחות בחשבון (הן אינן נחשבות לחלק משם המתמיד לצורך אלפביתי). לכן אנו משווים את האות **b** של **butyl** מול האות **m** של **methyl**.
  - מאחר ו-**b** קודמת ל-**m**, קבוצת ה-tert-butyl מקבלת את העדיפות הראשונה ומסומנת כפחמן מספר 1.

**שלב 3: כתיבת השם**
השם המלא הוא **1-tert-butyl-4-methylcyclohexane** (הערה: IUPAC מקבלת את השם tert-butyl גם בשיטה הסיסטמתית הרשמית, ושם זה עדיף ונפוץ במבחנים).`
  },
  {
    id: 64,
    category: "nomenclature_functional",
    title: "נומנקלטורה של אלקינים המכילים קבוצת כוהל",
    text: "מהו השם הסיסטמתי (IUPAC) הנכון עבור המולקולה הבאה המכילה קשר משולש וכוהל?",
    svg: `<svg viewBox="0 0 320 130" width="100%" height="130" style="background:#1e293b; border-radius:8px; direction: ltr;">
      <!-- Pentyn-ol chain -->
      <line x1="50" y1="80" x2="90" y2="50" stroke="#f8fafc" stroke-width="3"/>
      <line x1="90" y1="50" x2="140" y2="80" stroke="#f8fafc" stroke-width="3"/>
      <line x1="140" y1="80" x2="190" y2="80" stroke="#f8fafc" stroke-width="3"/>
      <!-- Triple bond representation between C4 and C5 (190,80 to 240,80) -->
      <line x1="190" y1="80" x2="240" y2="80" stroke="#38bdf8" stroke-width="5"/>
      <line x1="190" y1="74" x2="240" y2="74" stroke="#f8fafc" stroke-width="2"/>
      <line x1="190" y1="86" x2="240" y2="86" stroke="#f8fafc" stroke-width="2"/>
      <!-- OH at C2 (90,50) -->
      <line x1="90" y1="50" x2="90" y2="25" stroke="#f43f5e" stroke-width="3"/>
      <text x="82" y="20" fill="#f43f5e" font-size="12" font-weight="bold">OH</text>
      <!-- Numbers for carbon identification -->
      <text x="45" y="95" fill="#94a3b8" font-size="10">1</text>
      <text x="85" y="62" fill="#f43f5e" font-size="10">2</text>
      <text x="135" y="95" fill="#94a3b8" font-size="10">3</text>
      <text x="185" y="95" fill="#38bdf8" font-size="10">4</text>
      <text x="235" y="95" fill="#38bdf8" font-size="10">5</text>
    </svg>`,
    options: [
      "pent-4-yn-2-ol",
      "pent-1-yn-4-ol",
    ...
    correctIndex: 0,
    explanation: `להלן ניתוח קביעת השם הסיסטמתי של המולקולה pent-4-yn-2-ol:

**שלב 1: זיהוי השרשרת הראשית והסיומת (Suffix)**
השרשרת הארוכה ביותר המכילה את שתי הקבוצות היא בת 5 פחמנים (Pent).
הקבוצות הפונקציונליות הן כוהל ($\ce{-OH}$) וקשר משולש ($\ce{C\equiv C}$).
מאחר וכוהל קודם לאלקין בסדר קדימויות הקבוצות, המולקולה תקבל את הסיומת **ol**, והאלקין ישולב כשם פנימי (**yn**).

**שלב 2: מספור השרשרת הראשית**
- מספור משמאל לימין: הכוהל מקבל את עמדה 2, והאלקין את עמדה 4 ⬅️ **pent-4-yn-2-ol**.
- מספור מימין לשמאל: האלקין מקבל את עמדה 1, והכוהל את עמדה 4.
מאחר וקבוצת הכוהל קובעת את כיוון המספור (היא בעלת הקדימות הגבוהה יותר), עלינו להעניק לה את המספר הנמוך ביותר האפשרי. לכן נבחר במספור משמאל לימין.

**שלב 3: הרכבת השם**
המולקולה היא פנטן בעל קשר משולש בפחמן 4 וכוהל בפחמן 2.
השם הסיסטמתי המלא הוא **pent-4-yn-2-ol**.`
  },
  {
    id: 65,
    category: "resonance_structures",
    title: "יציבות יחסית של מבני רזוננס בקבוצת אמיד (Amide)",
    text: "עבור קבוצת האמיד (CH3-CONH2), מהו המשפט הנכון לגבי מבני הרזוננס שלה ואופי הקשר בין הפחמן לחנקן?",
    svg: `<svg viewBox="0 0 350 120" width="100%" height="120" style="background:#1e293b; border-radius:8px; direction: ltr;">
      <!-- Struct I -->
      <text x="20" y="60" fill="#f8fafc" font-size="14" font-family="Arial" font-weight="bold">H₃C—C(=O)—NH₂ (I)</text>
      <!-- Resonance double arrow -->
      <text x="165" y="60" fill="#38bdf8" font-size="16" font-weight="bold">↔</text>
      <!-- Struct II -->
      <text x="195" y="60" fill="#f8fafc" font-size="14" font-family="Arial" font-weight="bold">H₃C—C(—O⁻)=NH₂⁺ (II)</text>
    </svg>`,
    options: [
      "מבנה I הוא התורם העיקרי (Major) כיוון שהוא ללא הפרדת מטענים, אך למבנה II יש תרומה משמעותית המעניקה לקשר C-N אופי חלקי של קשר כפול.",
      "מבנה II הוא התורם העיקרי מכיוון שהחנקן נושא מטען חיובי יציב יותר מפחמן.",
      "מבנה II אינו תורם כלל להיבריד הרזוננס כיוון שחמצן שלילי וחנקן חיובי אינם יציבים זה לצד זה.",
      "שני המבנים תורמים במידה שווה לחלוטין ולכן הקשר C-N הוא קשר כפול מלא המונע לחלוטין כל סיבוב."
    ],
    correctIndex: 0,
    explanation: `להלן ניתוח הרזוננס של קבוצת האמיד (אחד מנושאי הליבה המקשרים לביוכימיה):

**1. הערכת יציבות המבנים:**
- **מבנה I (הניטרלי):** יציב יותר ותורם עיקרי (Major contributor) להיבריד הרזוננס משום שאין בו הפרדת מטענים פורמליים.
- **מבנה II (הדו-קוטבי):** למרות שיש בו הפרדת מטענים, לכל האטומים (כולל פחמן, חמצן וחנקן) יש **אוקטט מלא**. לכן מבנה זה יציב יחסית ובעל תרומה משמעותית מאוד להיבריד הרזוננס (אינו זניח).

**2. השפעה על אופי הקשרים במציאות (היבריד הרזוננס):**
בשל התרומה של מבנה II, הקשר שבין הפחמן הקרבונילי לחנקן ($\ce{C-N}$) אינו קשר יחיד רגיל אלא בעל **אופי חלקי של קשר כפול**. 
- אופי קשר כפול זה יוצר מחסום אנרגטי גבוה לסיבוב סביב קשר ה-$\ce{C-N}$ בטמפרטורת החדר.
- החנקן מקבל אופי של היברידיזציה הקרובה ל-$	ext{sp}^2$ והקבוצה כולה נוטה להיות שטוחה (planar), תכונה קריטית ביותר ליצירת מבנים שניוניים של חלבונים (קשרים פפטידיים).`
  },
  {
    id: 66,
    category: "acid_base",
    title: "השוואת חומציות: כוהל אליפטי, פנול וחומצה קרבוקסילית",
    text: "סדרו את החומרים הבאים לפי סדר חומציות יורד (מהחומצי ביותר לבסיסי ביותר):",
    svg: `<svg viewBox="0 0 350 120" width="100%" height="120" style="background:#1e293b; border-radius:8px; direction: ltr;">
      <text x="30" y="40" fill="#f8fafc" font-size="14" font-weight="bold">A: CH₃COOH (Acetic acid)</text>
      <text x="30" y="70" fill="#f8fafc" font-size="14" font-weight="bold">B: C₆H₅OH (Phenol)</text>
      <text x="30" y="100" fill="#f8fafc" font-size="14" font-weight="bold">C: CH₃CH₂OH (Ethanol)</text>
    </svg>`,
    options: [
      "A > B > C",
      "C > B > A",
    ...
    correctIndex: 0,
    explanation: `להלן ניתוח גורמי יציבות הבסיס המצומד הקובעים את חוזק החומציות של קבוצות אלו:

**1. חומצה אצטית (A - $pK_a pprox 4.75$):**
לאחר איבוד הפרוטון, מתקבל יון הקרבוקסילאט ($\ce{CH3COO^-}$). המטען השלילי מיוצב על ידי רזוננס ומתחלק באופן שווה לחלוטין בין **שני אטומי חמצן אלקטרושליליים וזהים**. ייצוב רזוננטיבי זה הוא החזק ביותר בקבוצה, ולכן זו החומצה החזקה ביותר.

**2. פנול (B - $pK_a pprox 10$):**
לאחר איבוד הפרוטון, מתקבל יון הפנוקסיד ($\ce{C6H5O^-}$). המטען השלילי מיוצב על ידי רזוננס לתוך הטבעת הארומטית. אולם, מבני הרזוננס הנוספים מציבים את המטען השלילי על אטומי הפחמן של הטבעת. מאחר ופחמן פחות אלקטרושלילי מחמצן, הייצוב פחות יעיל מזה של חומצה קרבוקסילית. לכן פנול חלש מחומצה קרבוקסילית אך חזק בהרבה מכוהל רגיל.

**3. אתנול (C - $pK_a pprox 16$):**
לאחר איבוד הפרוטון מתקבל יון האתוקסיד ($\ce{CH3CH2O^-}$). המטען השלילי ממוקם כולו על אטום חמצן יחיד **ללא שום ייצוב רזוננס**. בנוסף, קבוצת האתיל היא קבוצה תורמת אלקטרונית קלה המערערת מעט את האניון. לכן אתנול הוא החומצה החלשה ביותר כאן.

סדר החומציות הנכון הוא אפוא: **A > B > C**.`
  },
  {
    id: 67,
    category: "conformations_newman",
    title: "קונפורמציות ניומן ויציבות יחסית של 1-propanol",
    text: "עבור מולקולת 1-propanol, מהי הקונפורמציה היציבה ביותר (המינימום האנרגטי הגלובלי) במבט לאורך קשר C1-C2?",
    svg: `<svg viewBox="0 0 300 130" width="100%" height="130" style="background:#1e293b; border-radius:8px; direction: ltr;">
      <!-- Newman shell -->
      <circle cx="150" cy="65" r="30" fill="none" stroke="#f8fafc" stroke-width="3"/>
      <!-- Front (C1) - OH top, H, H -->
      <line x1="150" y1="65" x2="150" y2="25" stroke="#f43f5e" stroke-width="3"/>
      <text x="142" y="20" fill="#f43f5e" font-size="12" font-weight="bold">OH</text>
      <line x1="150" y1="65" x2="115" y2="85" stroke="#f8fafc" stroke-width="3"/>
      <line x1="150" y1="65" x2="185" y2="85" stroke="#f8fafc" stroke-width="3"/>
      <!-- Back (C2) - CH3 bottom, H, H -->
      <line x1="150" y1="95" x2="150" y2="120" stroke="#38bdf8" stroke-width="3"/>
      <text x="138" y="132" fill="#38bdf8" font-size="11" font-weight="bold">CH₃</text>
      <line x1="124" y1="50" x2="100" y2="35" stroke="#f8fafc" stroke-width="3"/>
      <line x1="176" y1="50" x2="200" y2="35" stroke="#f8fafc" stroke-width="3"/>
    </svg>`,
    options: [
      "קונפורמציית anti שבה קבוצת ה-CH3 וקבוצת ה-OH נמצאות בזווית דיהדרלית של 180° זו מזו.",
      "קונפורמציית gauche שבה קבוצת ה-CH3 וקבוצת ה-OH נמצאות בזווית דיהדרלית של 60° זו מזו.",
      "קונפורמציית eclipsed שבה קבוצת ה-CH3 וה-OH חופפות לחלוטין במרחב.",
      "קונפורמציות ה-anti וה-gauche הן בעלות אותה אנרגיה בדיוק עקב היעדר הפרעה סטרית."
    ],
    correctIndex: 0,
    explanation: `להלן ניתוח קונפורמציות המולקולה 1-propanol לאורך קשר C1-C2:

**1. זיהוי המתמירים על פחמני הקשר C1-C2:**
- לפחמן הקדמי (C1) מחוברים: קבוצת כוהל ($\ce{-OH}$) ושני מימנים ($\ce{-H}$).
- לפחמן האחורי (C2) מחוברים: קבוצת מתיל ($\ce{-CH3}$) ושני מימנים ($\ce{-H}$).

**2. השוואת קונפורמציות staggered:**
כאשר נסתכל על הקונפורמציות היציבות יחסית (staggered):
- **קונפורמציית anti (המשורטטת ב-SVG):** קבוצת ה-$\ce{-CH3}$ הגדולה וקבוצת ה-$\ce{-OH}$ ממוקמות במרחק המרבי האפשרי זו מזו (זווית של 180°). מצב זה ממזער את הדחייה הסטרית (ואן-דר-ואלס) ביניהן למינימום האפשרי.
- **קונפורמציית gauche:** קבוצת ה-$\ce{-CH3}$ וה-$\ce{-OH}$ נמצאות בזווית של 60° זו מזו. מצב זה מייצר אינטראקציית גוש סטרית המעלה את האנרגיה החופשית של המולקולה בכ-0.9 קק"ל/מול (הערה: בממסים מסוימים עשוי להיווצר קשר מימן חלש, אך במצב גז או בממסים אינרטיים קונפורמציית anti היא תמיד המינימום הגלובלי היציב ביותר).
...
לכן קונפורמציית **anti** היא היציבה ביותר.`
  },
  {
    id: 68,
    category: "conformations_chair",
    title: "שיווי משקל והיפוך טבעת בציקלוהקסאן 1,1-דו-מותמר",
    text: "עבור מולקולת 1,1-dimethylcyclohexane, מהו המשפט הנכון לגבי שיווי המשקל ויציבות קונפורמציות הכיסא שמתקבלות בעת היפוך טבעת (Ring Flip)?",
    svg: `<svg viewBox="0 0 320 130" width="100%" height="130" style="background:#1e293b; border-radius:8px; direction: ltr;">
      <!-- Representation text -->
      <text x="30" y="45" fill="#f8fafc" font-size="13" font-weight="bold">כיסא א' (1-axial, 1-equatorial)</text>
      <text x="145" y="75" fill="#38bdf8" font-size="18" font-weight="bold">⇌</text>
      <text x="30" y="105" fill="#f8fafc" font-size="13" font-weight="bold">כיסא ב' (1-equatorial, 1-axial)</text>
    </svg>`,
    options: [
      "שתי קונפורמציות הכיסא הן בעלות אנרגיה זהה לחלוטין (קבועות שיווי משקל K = 1), מכיוון שבכל אחת מהן מתיל אחד אקסיאלי והשני אקווטוריאלי.",
      "קונפורמציה אחת יציבה בהרבה מהשנייה משום שהיא מאפשרת לשני המתילים להיות אקווטוריאליים בו-זמנית.",
      "המולקולה אינה מסוגלת לעבור היפוך טבעת כלל בגלל מתח סטרי עצום של שני מתילים על אותו פחמן.",
      "היפוך הטבעת מוביל ליצירת קונפורמציית סירה מעוותת שהיא יציבה יותר מקונפורמציית הכיסא."
    ],
    correctIndex: 0,
    explanation: `להלן הניתוח המנגנוני של היפוך טבעת בציקלוהקסאן 1,1-דו-מותמר:

**1. זיהוי עמדות המתמירים:**
במולקולת $	ext{1,1-dimethylcyclohexane}$, שני מתמירי המתיל ($\ce{-CH3}$) מחוברים לאותו אטום פחמן (C1) בטבעת:
- בקונפורמציית כיסא כלשהי של המולקולה, מתיל אחד חייב להצביע כלפי מעלה (עמדה אקסיאלית במקרה זה) והמתיל השני חייב להצביע הצידה/מטה (עמדה אקווטוריאלית).
- כלומר, המצב הוא תמיד: **מתיל אחד אקסיאלי ומתיל אחד אקווטוריאלי (1a, 1e)**.

**2. ניתוח תוצאות היפוך הטבעת (Ring Flip):**
כאשר מתרחש היפוך טבעת:
- המתיל שהיה אקסיאלי (axial) הופך לאקווטוריאלי (equatorial).
- המתיל שהיה אקווטוריאלי (equatorial) הופך לאקסיאלי (axial).
- כתוצאה מכך, הקונפורמציה החדשה שהתקבלה היא שוב בעלת **מתיל אחד אקסיאלי ומתיל אחד אקווטוריאלי (1e, 1a)**.

**3. השוואת אנרגיות:**
מאחר ושתי הקונפורמציות בעלות אותו הרכב בדיוק של מתמירים (מתיל אחד אקסיאלי ומתיל אחד אקווטוריאלי), הן זהות לחלוטין מבחינה אנרגטית (Degenerate conformations). 
שיווי המשקל ביניהן הוא שווה לחלוטין ($K_{eq} = 1$), והן נמצאות ביחס של 50:50 בתמיסה.`
  },
  {
    id: 69,
    category: "stereochemistry_centers",
    title: "סטריאוכימיה של אלנים (Allenes) ללא פחמנים כיראליים",
    text: "עבור המולקולה 2,3-pentadiene (אלן המכיל קשרים כפולים צמודים), מהו המשפט הנכון לגבי כיראליות המולקולה?",
    svg: `<svg viewBox="0 0 320 130" width="100%" height="130" style="background:#1e293b; border-radius:8px; direction: ltr;">
      <!-- Allene structure representation -->
      <line x1="50" y1="65" x2="100" y2="65" stroke="#f8fafc" stroke-width="5"/> <!-- C=C -->
      <line x1="50" y1="59" x2="100" y2="59" stroke="#f8fafc" stroke-width="2"/>
      <line x1="100" y1="65" x2="150" y2="65" stroke="#38bdf8" stroke-width="5"/> <!-- C=C second -->
      <line x1="100" y1="71" x2="150" y2="71" stroke="#f8fafc" stroke-width="2"/>
      <!-- Substituents on C2 (50,65): H and CH3 -->
      <line x1="50" y1="65" x2="20" y2="35" stroke="#f8fafc" stroke-width="3"/>
      <line x1="50" y1="65" x2="20" y2="95" stroke="#f8fafc" stroke-width="3"/>
      <!-- Substituents on C4 (150,65): H (wedge) and CH3 (dash) -->
      <polygon points="150,65 175,35 180,40" fill="#38bdf8" stroke="#38bdf8"/> <!-- Wedge -->
      <line x1="150" y1="65" x2="180" y2="95" stroke="#f43f5e" stroke-width="3" stroke-dasharray="3"/> <!-- Dash -->
      <text x="10" y="30" fill="#f8fafc" font-size="10">H</text>
      <text x="5" y="105" fill="#f8fafc" font-size="10">CH₃</text>
      <text x="180" y="30" fill="#38bdf8" font-size="10">CH₃</text>
      <text x="185" y="105" fill="#f43f5e" font-size="10">H</text>
    </svg>`,
    options: [
      "המולקולה כיראלית ופעילה אופטית (קיימים לה שני אננטיומרים) בגלל קיומו של ציר כיראלי (Chiral axis) המונע קיום מישור סימטריה פנימי.",
      "המולקולה אקיראלית לחלוטין מכיוון שאין בה אף אטום פחמן הקשור ל-4 מתמירים שונים (פחמן כיראלי).",
      "המולקולה היא תרכובת מיזו (Meso) מכיוון שיש לה מישור סימטריה פנימי החוצה את הפחמן המרכזי.",
      "המולקולה אינה יציבה מבחינה כימית ותעבור שחלוף מיידי לאלקין פנימי אקיראלי."
    ],
    correctIndex: 0,
    explanation: `זהו מקרה קלאסי של כיראליות ללא מרכז כיראלי (Chirality without a stereocenter) הנפוץ מאוד במבחנים:

**1. הגיאומטריה המרחבית של אלנים:**
באלנים ($\ce{C=C=C}$), הפחמן המרכזי נמצא בהיברידיזציית **sp** והוא יוצר שני קשרי $\pi$ מאונכים זה לזה:
- קשר ה-$\pi$ הראשון נוצר על ידי אורביטלי p השוכנים במישור xz.
- קשר ה-$\pi$ השני נוצר על ידי אורביטלי p השוכנים במישור yz המאונך לו.
כתוצאה מכך, שתי קבוצות המתמירים בקצוות המולקולה שוכנות ב**מישורים מאונכים זה לזה (זווית של 90°)**.

**2. כיראליות וסימטריה:**
- באיזומר של $	ext{2,3-pentadiene}$, לכל קצה של האלן מחוברים שני מתמירים שונים ($\ce{-H}$ ו-$\ce{-CH3}$).
- בגלל המבנה המאונך שלהם, אין למולקולה מישור סימטריה פנימי ($\sigma$) ואין לה מרכז סימטריה ($i$).
- המולקולה אינה חופפת לתמונת הראי שלה, ולכן היא **כיראלית** ומפגינה פעילות אופטית (קיימים לה שני אננטיומרים). כיראליות זו נובעת מ**ציר כיראלי (Chiral axis)** ולא ממרכז כיראלי קלאסי.`
  },
  {
    id: 70,
    category: "stereochemistry_relationships",
    title: "קשרים סטריאוכימיים בפחמימות – אננטיומרים מול דיאסטראומרים",
    text: "מהו הקשר הסטריאוכימי הנכון בין הזוגות הבאים: (1) D-glucose ו-L-glucose, ו-(2) D-glucose ו-D-galactose?",
    svg: `<svg viewBox="0 0 320 130" width="100%" height="130" style="background:#1e293b; border-radius:8px; direction: ltr;">
      <!-- Representation text -->
      <text x="30" y="45" fill="#f8fafc" font-size="13" font-weight="bold">1. D-glucose vs L-glucose</text>
      <text x="30" y="85" fill="#f8fafc" font-size="13" font-weight="bold">2. D-glucose vs D-galactose</text>
    </svg>`,
    options: [
      "הזוג הראשון הם אננטיומרים (תמונות ראי), והזוג השני הם דיאסטראומרים (אפימרים).",
      "הזוג הראשון הם דיאסטראומרים, והזוג השני הם אננטיומרים.",
      "שני הזוגות הם אננטיומרים.",
      "שני הזוגות הם דיאסטראומרים."
    ],
    correctIndex: 0,
    explanation: `להלן הגדרת הקשרים הסטריאוכימיים במולקולות סוכר (פחמימות):

**1. D-glucose לעומת L-glucose:**
סוכר D וסוכר L מוגדרים כתמונות ראי מושלמות זה של זה:
- כל המרכזים הכיראליים במולקולה עוברים היפוך מוחלט (כל R הופך ל-S וההפך).
- מאחר והמולקולות הן תמונות ראי לא חופפות, הן **אננטיומרים** (Enantiomers).

**2. D-glucose לעומת D-galactose:**
סוכרים אלו נבדלים זה מזה בקונפיגורציה של מרכז כיראלי יחיד בלבד (פחמן מספר 4):
- שאר המרכזים הכיראליים נשארים בעלי קונפיגורציה זהה.
- מאחר והן מולקולות בעלות נוסחה מולקולרית זהה וקישוריות זהה, אך אינן תמונות ראי זו של זו (ההיפוך הוא חלקי בלבד ולא של כל המרכזים), הן **דיאסטראומרים** (Diastereomers).
- באופן ספציפי, דיאסטראומרים הנבדלים במרכז כיראלי יחיד נקראים גם **אפימרים** (Epimers).

לכן, הזוג הראשון הם אננטיומרים והזוג השני הם דיאסטראומרים.`
  },
  {
    id: 71,
    category: "reactions_addition",
    title: "הידרציה של אלקינים – הידרובורציה מול הידרציה חומצית",
    text: "מהם התוצרים המתקבלים בתגובות הבאות של האלקין 1-butyne: (1) הידרובורציה-חמצון (1. R2BH, 2. H2O2/OH-) ו-(2) הידרציה חומצית מזורזת כספית (H2O, H2SO4, HgSO4)?",
    svg: `<svg viewBox="0 0 320 130" width="100%" height="130" style="background:#1e293b; border-radius:8px; direction: ltr;">
      <!-- Reactant 1-butyne -->
      <line x1="30" y1="80" x2="70" y2="80" stroke="#f8fafc" stroke-width="3"/>
      <!-- Triple bond C1-C2 -->
      <line x1="70" y1="80" x2="120" y2="80" stroke="#38bdf8" stroke-width="5"/>
      <line x1="70" y1="74" x2="120" y2="74" stroke="#f8fafc" stroke-width="2"/>
      <line x1="70" y1="86" x2="120" y2="86" stroke="#f8fafc" stroke-width="2"/>
      <line x1="120" y1="80" x2="160" y2="50" stroke="#f8fafc" stroke-width="3"/>
      <!-- Reagents arrows -->
      <text x="180" y="50" fill="#f43f5e" font-size="11" font-weight="bold">1. R₂BH / H₂O₂ ➔ A</text>
      <text x="180" y="90" fill="#eab308" font-size="11" font-weight="bold">2. H⁺, Hg²⁺ / H₂O ➔ B</text>
    </svg>`,
    options: [
      "תוצר A הוא butanal (אלדהיד), ותוצר B הוא 2-butanone (קטון).",
      "תוצר A הוא 2-butanone (קטון), ותוצר B הוא butanal (אלדהיד).",
      "שתי התגובות מניבות את אותו התוצר בדיוק (butanal) לאחר טאוטומריזציה.",
      "שתי התגובות מניבות את אותו התוצר בדיוק (2-butanone) לאחר טאוטומריזציה."
    ],
    correctIndex: 0,
    explanation: `להלן ניתוח תגובות הסיפוח לקשר משולש קצה (Terminal Alkyne):

**1. תגובה 1: הידרובורציה-חמצון (Hydroboration-Oxidation):**
- **רגיוסלקטיביות:** אנטי-מרקובניקוב (Anti-Markovnikov). הבורן נקשר לפחמן הקצה הפחות מותמר (C1).
- **שלב ראשון:** סיפוח של H ו-BR₂ לקבלת אנול (enol) ביניים: $\ce{CH3-CH2-CH=CH-OH}$.
- **שלב שני:** ה-enol אינו יציב ועובר טאוטומריזציה מהירה (קטו-אנול) ליצירת קשר קרבונילי בקצה השרשרת.
- **תוצר סופי:** אלדהיד בן 4 פחמנים – **butanal**.

**2. תגובה 2: הידרציה מזורזת כספית ($\ce{HgSO4/H2SO4}$):**
- **רגיוסלקטיביות:** מרקובניקוב (Markovnikov). המים (קבוצת ה-OH) מסתפחים לפחמן הפנימי המותמר יותר (C2).
- **שלב ראשון:** יצירת enol ביניים פנימי: $\ce{CH3-CH2-C(OH)=CH2}$.
- **שלב שני:** ה-enol עובר טאוטומריזציה מהירה לקטו-אנול.
- **תוצר סופי:** קטון בן 4 פחמנים – **2-butanone** (Methyl ethyl ketone).

לכן, תוצר A הוא butanal ותוצר B הוא 2-butanone.`
  },
  {
    id: 72,
    category: "reactions_cleavage",
    title: "אוזונוליזה חריפה (אוקסידטיבית) של אלקנים טבעתיים",
    text: "מהו התוצר העיקרי שיתקבל בתגובת האוזונוליזה האוקסידטיבית (1. O3, 2. H2O2) של המולקולה 1-methylcyclopentene?",
    svg: `<svg viewBox="0 0 320 130" width="100%" height="130" style="background:#1e293b; border-radius:8px; direction: ltr;">
      <!-- 1-methylcyclopentene -->
      <polygon points="100,35 135,60 120,105 80,105 65,60" fill="none" stroke="#f8fafc" stroke-width="3"/>
      <!-- Double bond between C1 (100,35) and C2 (135,60) -->
      <line x1="99" y1="43" x2="127" y2="62" stroke="#f8fafc" stroke-width="2"/>
      <!-- Methyl at C1 -->
      <line x1="100" y1="35" x2="100" y2="8" stroke="#38bdf8" stroke-width="3"/>
      <!-- Reagents -->
      <text x="180" y="55" fill="#38bdf8" font-size="12" font-weight="bold">1. O₃</text>
      <text x="180" y="75" fill="#38bdf8" font-size="12" font-weight="bold">2. H₂O₂ (מחמצן)</text>
    </svg>`,
    options: [
      "5-oxohexanoic acid",
      "5-oxohexanal",
      "hexanedioic acid",
      "2-methylcyclopentane-1,2-diol"
    ],
    correctIndex: 0,
    explanation: `להלן ניתוח תגובת האוזונוליזה תחת תנאי חימצון (Oxidative Workup):

**שלב 1: ביקוע הקשר הכפול ופתיחת הטבעת**
הקשר הכפול $\ce{C=C}$ נפתח ומבוקע לחלוטין. הטבעת המחומשת הופכת לשרשרת פתוחה בת 6 פחמנים (5 פחמני טבעת + 1 פחמן מתיל).

**שלב 2: קביעת אופי הפחמנים המבוקעים**
נסתכל על פחמני האלקן המבוקעים:
1. **פחמן C1 (הקשור למתיל):** הוא פחמן שלישוני. ביקוע שלו יוצר קבוצת קטון: $\ce{CH3-C(=O)-...}$
2. **פחמן C2 (הקשור למימן):** הוא פחמן שניוני. 

**שלב 3: רמת החימצון של התוצרים בתנאי H2O2**
- באוזונוליזה מחזרת רגילה ($	ext{DMS}$ או $	ext{Zn}$), פחמן C2 השניוני היה הופך לאלדהיד ($\ce{-CHO}$).
- אולם, התגובה מבוצעת בנוכחות **מי חמצן ($\ce{H2O2}$)**, שהם תנאי חימצון (Oxidative workup). תנאים אלו מחמצנים כל אלדהיד שנוצר לרמת החומציות המקסימלית – **חומצה קרבוקסילית ($\ce{-COOH}$)**. (קטונים אינם מתחמצנים ונשארים ללא שינוי).
התוצר שהתקבל הוא שרשרת פתוחה בת 6 פחמנים שבקצה אחד שלה חומצה קרבוקסילית ובפחמן 5 שלה קבוצת קטון (Oxo).

התוצר הוא **5-oxohexanoic acid**.`
  }
